...
function Signup() {
  ...
  const signup = async (e) => {
    e.preventDefault()
    // e.preventDefault();
    let res = await ApiHelperFunction({ urlPath: "user/signup", method: "post", formData })
    ...
    <>
      <div className='h-screen w-screen flex justify-center items-center'>
        ...
        <form onSubmit={signup} className='p-4 rounded-md shadow-md border-gray-200 w-4/12'>
          <h2 className='text-blue-400 text-center mb-4 text-lg font-bold'>SignUp</h2>
          ...
          <div className='flex justify-end mb-2'>
            ...
            <button type='submit' className='text-white p-2 rounded-md bg-blue-400 hover:bg-blue-500'>SignUp</button>
          </div>
          <Link to={"/"} className='text-center text-purple-500 underline'>
